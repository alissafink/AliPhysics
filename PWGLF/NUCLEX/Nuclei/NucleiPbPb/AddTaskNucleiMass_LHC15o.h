#ifndef AddTaskNucleiMass_LHC15o_cxx
#define AddTaskNucleiMass_LHC15o_cxx
...
class AddTaskNucleiMass_LHC15o : public AliAnalysisTaskSE {
    
public:
    AddTaskNucleiMass_LHC15o();
    AddTaskNucleiMass_LHC15o(const char *name);
    virtual ~AddTaskNucleiMass_LHC15o();
...
private:
    ...
    AddTaskNucleiMass_LHC15o(const AddTaskNucleiMass_LHC15o&);
    AddTaskNucleiMass_LHC15o& operator=(const AddTaskNucleiMass_LHC15o&);
    
    ClassDef(AddTaskNucleiMass_LHC15o, 1);
};
#endif
