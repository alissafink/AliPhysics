#include "AliAnalysisTask_Alissa.h"
...
ClassImp(AliAnalysisTask_Alissa)

//_________________________________________________________________________________________________________________________________________________________________________________________________
AliAnalysisTask_Alissa::AliAnalysisTask_Alissa():
AliAnalysisTaskSE(),
fAODevent(0x0),
fOutputList(0x0),
fPIDResponse(0x0)
{}
//_________________________________________________________________________________________________________________________________________________________________________________________________
AliAnalysisTask_Alissa::AliAnalysisTask_Alissa(const char *name):
...
//_________________________________________________________________________________________________________________________________________________________________________________________________
void AliAnalysisTask_Alissa::UserCreateOutputObjects()
{
    //PIDResponse
...
//_________________________________________________________________________________________________________________________________________________________________________________________________
void AliAnalysisTask_Alissa::UserExec(Option_t *)
{
...
//Get Event
Bool_t AliAnalysisTask_Alissa::GetEvent(){
...
//Get DCAXY
Double_t AliAnalysisTask_Alissa::GetDCAXY (AliAODTrack *track)  {
...
//Get DCAZ
Double_t AliAnalysisTask_Alissa::GetDCAZ (AliAODTrack *track)  {
...
Double_t AliAnalysisTask_Alissa::GetSharedClusters (AliAODTrack *track) {
...
//_________________________________________________________________________________________________________________________________________________________________________________________________
Bool_t AliAnalysisTask_Alissa::TrackQualityCuts(AliAODTrack *track){
...
//_________________________________________________________________________________________________________________________________________________________________________________________________
Double_t AliAnalysisTask_Alissa::Beta(AliAODTrack *track){
...
Double_t AliAnalysisTask_Alissa::Mass(AliAODTrack *track){
...
Bool_t AliAnalysisTask_Alissa::Proton_Candidate(AliAODTrack *track){
...
//__________________________________________________________________________________________________________________________________________________________________
Bool_t AliAnalysisTask_Alissa::Deuteron_Candidate(AliAODTrack *track){
...
//__________________________________________________________________________________________________________________________________________________________________
Bool_t AliAnalysisTask_Alissa::He3_Candidate(AliAODTrack *track){
...
//__________________________________________________________________________________________________________________________________________________________________
Bool_t AliAnalysisTask_Alissa::He4_Candidate(AliAODTrack *track){
    
    Double_t signal_He4 = TMath::Abs(fPIDResponse->NumberOfSigmasTPC(track,AliPID::kAlpha));
    if(signal_He4>3) return false;
    
    return true;
}
//__________________________________________________________________________________________________________________________________________________________________
Bool_t AliAnalysisTask_Alissa::Triton_Candidate(AliAODTrack *track)  {
    
    Double_t signal_Triton = TMath::Abs(fPIDResponse->NumberOfSigmasTPC(track,AliPID::kTriton));
	if(track->Pt()<1.2 || track->Pt()>1.8) return false;
    if(signal_Triton>3) return false;
    
    return true;
}
//_________________________________________________________________________________________________________________________________________________________________________________________________
void AliAnalysisTask_Alissa::Terminate(Option_t *)  {
